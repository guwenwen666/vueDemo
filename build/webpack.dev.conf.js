...
//能够更好在终端看到webpack运行的警告和错误
const FriendlyErrorsPlugin = require('friendly-errors-webpack-plugin')
const portfinder = require('portfinder')//自动检索下一个可用端口

const HOST = process.env.HOST//读取系统环境变量中的host
const PORT = process.env.PORT && Number(process.env.PORT)//读取系统环境变量中的port
...
const devWebpackConfig = merge(baseWebpackConfig, {
  ...
  devtool: config.dev.devtool,//添加元信息增强测试
